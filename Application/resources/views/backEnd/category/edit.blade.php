...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Retourner à l'accueil!" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="{{route('category.index')}}">Categories</a> <a href="#" class="current">Modifier Categorie</a> </div>
