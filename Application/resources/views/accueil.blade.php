    ...
    <body>
        <nav>
            <ul>
                ...
                <?php } else { ?>
                    <li><a class="menu" href="fournitures" onmouseover="afficherMenu(menu_lateral)" onmouseout="cacherMenu(menu_lateral)">FOURNITURES</a></li>
        ...
        <nav id="menu_lateral"  onmouseover="afficherMenu(menu_lateral)" onmouseout="cacherMenu(menu_lateral)">
            <ul id="ul_menu_lateral">
                <li id="li_menu_lateral"><a class="menu_lateral" href="accueil#navlistecomptes">Liste des comptes</a></li>
                <li id="li_menu_lateral"><a class="menu_lateral" href="accueil#supprimer_tous">Supprimer tous les messages</a></li>
                <li id="li_menu_lateral"><a class="menu_lateral" href="accueil#liste_commandes">Liste des commandes en cours</a></li>
            </ul>
        </nav>
        <header>
            <h1>Accueil</h1>
