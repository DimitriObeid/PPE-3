...
<!--
        <div class="category-tab shop-details-tab">
            <div class="col-sm-12">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#companyprofile" data-toggle="tab">Profil de l'entreprise</a></li>
        ...
        <div class="recommended_items"><!--recommended_items-->
            <h2 class="title text-center">Produits recommendés</h2>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>{{$item->price}}</h2>
                                                <p>{{$item->p_name}}</p>
                                                <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Ajouter</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
