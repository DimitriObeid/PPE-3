...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('product.create')->with('message','Produits ajoutés avec succès!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('product.index')->with('message','Produit mise à jour avec succès!');
    }
